...
class TestSupplementXmlReader(unittest.TestCase):
    ...
    def test_material(self):
        ...
        with open(xml_file_path, 'w') as fp:
            ...
            <ns0:pmxstatus xmlns:ns0="local" xml:lang="jp">
            <materials>
            <material b_name="mat1" both="0" drop_shadow="1" edge_size="1.0" ground_shadow="1" name="マテリアル1" name_e="mat 1" on_edge="1" on_shadow="1" toon="0" use_systemtoon="1" memo="test&#10;test"><edge_color a="1.0" b="0.0" g="0.0" r="0.0" /><deffuse a="1.0" b="0.7098038792610168" g="0.9411764740943909" r="1.0" /><specular b="0.07000000029802322" g="0.07000000029802322" r="0.07000000029802322" /><ambient b="0.23999999463558197" g="0.3199999928474426" r="0.44999998807907104" /></material>
        ...
        self.assertEqual(element_dict['mat1'].memo, 'test\ntest')
        ...
        self.assertEqual(element_dict['mat2'].memo, None)
        ...
        self.assertEqual(element_dict['mat3'].memo, None)
